...
The eight audit categories, what to look for in each, and the exact target values to cite in findings and plans. This is the house craft bar for motion audits. Never approximate a value that appears here — copy it.
