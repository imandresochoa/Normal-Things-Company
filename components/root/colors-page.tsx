...
const SEMANTIC_COPY: Record<string, string> = {
  ...
  "Text and icons": "Primary, secondary, and tertiary ink. Group titles use Neutral 1000. Disabled controls use Neutral 500. Inverse ink on filled controls, and the two chromatic marks.",
    ...
    <article className="root-doc">
      ...
      <section className="root-doc-section">
        ...
        <p>
          ...
          500. Group titles use Neutral 1000. Body uses Neutral 900.
          Disabled controls use Neutral 500. Active ink stays{" "}
